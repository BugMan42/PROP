...
public class DriverRelacionCompuestaNot {

    private static RelacionCompuestaNot R;
    ...
    private static void PresentaMenu() {
        print("\nDRIVER Relacion Compuesta Not");
        print("0 RelacionCompuestaNot(Relacion a)");
